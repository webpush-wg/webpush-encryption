...
cryptographically strong random number generator [RFC4086] and contain at least
96 bits of entropy.
...
The content encryption key derivation process defined in Section 3.2 of
[I-D.thomson-http-encryption] takes input keying material, salt, and an expanded
context.  The expanded context the context from Section 4.2 of
[I-D.thomson-http-encryption] with the authentication secret appended, as
follows:
...
[I-D.thomson-http-encryption].  The same expanded context that is described in
{{derivation}} is used for key derivation.
